const translations = {
    'zh-TW': {
        ...
        'btn_disconnect': '斷開連線',
        'header_result': '測試結果',
        'btn_clear_record': '清除紀錄',
        'btn_clear_result': '清除結果',
        'text_waiting': '等待測試',
        'header_uuid': 'UUID 設定',
    ...
    'zh-CN': {
        ...
        'btn_disconnect': '断开连接',
        'header_result': '测试结果',
        'btn_clear_record': '清除记录',
        'btn_clear_result': '清除结果',
        'text_waiting': '等待测试',
        'header_uuid': 'UUID 设置',
        'label_service': 'Service UUID',
        'placeholder_service': '例如: 0000180d-0000-1000-8000-00805f9b34fb',
    ...
    'en': {
        ...
        'btn_clear_record': 'Clear Record',
        'btn_clear_result': 'Clear Result',
    ...
    'vi': {
        ...
        'btn_clear_record': 'Xóa bản ghi',
        'btn_clear_result': 'Xóa kết quả',
